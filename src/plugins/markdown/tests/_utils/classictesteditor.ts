 ...
 */
export class ClassicTestEditor extends Editor {
  /**
   * @inheritDoc
   */
  constructor(sourceElementOrData, config) {
    ...
    this.ui.view.editable = new InlineEditableUIView(
      this.ui.view.locale,
      this.editing.view
    );
  }
    ...
    return new Promise((resolve) => {
      ...
      resolve(
        editor
          ...
          .then(() =>
            editor.ui.init(
              isElement(sourceElementOrData) ? sourceElementOrData : null
            )
          )
          .then(() =>
            editor.editing.view.attachDomRoot(editor.ui.getEditableElement())
          )
          .then(() => {
...
function getInitialData(sourceElementOrData) {
  return isElement(sourceElementOrData)
